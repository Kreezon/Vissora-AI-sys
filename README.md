...
![Vissora AI - Main Page](Output%20Pics/Main.png)
...
<!-- Add your summary screenshot below -->

![Vissora AI - Summary](Output%20Pics/Summary.png)
...
<!-- Add your chatbot screenshot below -->

![Vissora AI - RAG Chatbot](Output%20Pics/Chat.png)
...
| **Sarvam AI**         | Hinglish speech-to-text              |
| **Mistral AI**        | Summarization, extraction & chatbot  |
| **LangChain**         | LLM and RAG pipeline                 |
| **ChromaDB**          | Vector database                      |
| **Vector Embeddings** | Semantic search over meeting content |
